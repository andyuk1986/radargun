 ...
 */
public class Infinispan150ServerClustered extends InfinispanServerClustered {
   ...
   public Infinispan150ServerClustered(Infinispan100ServerService service, Integer defaultPort, String username, String password) throws IOException {
      super(service);
