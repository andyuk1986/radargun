 ...
 */
public class Infinispan100RestAPI extends AbstractInfinispanRestAPI {
   ...
   public Infinispan100RestAPI(Integer serverPort, String username, String password) throws IOException {
